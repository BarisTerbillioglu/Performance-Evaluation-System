...
namespace PerformanceEvaluation.Infrastructure.Migrations
{
    ...
    [Migration("20250819082256_UpdateDeleteBehaviorsForCascading")]
    partial class UpdateDeleteBehaviorsForCascading
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PerformanceEvaluation.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            LastName = "Admin",
                            PasswordHash = "$2a$11$2AsZka8fR4cWQR7ykVRTV.KEhAghuukqVYUYalSxh1wGaghg7MbbO"
                        });
                });
