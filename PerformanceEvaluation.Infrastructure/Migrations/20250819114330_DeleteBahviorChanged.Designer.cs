...
namespace PerformanceEvaluation.Infrastructure.Migrations
{
    ...
    [Migration("20250819114330_DeleteBahviorChanged")]
    partial class DeleteBahviorChanged
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PerformanceEvaluation.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            LastName = "Admin",
                            PasswordHash = "$2a$11$8O4wDGnPXWOMHxPDyEp.r.0Es016PrV9UEns3gQAJuFlwHzRU86vq"
                        });
                });
